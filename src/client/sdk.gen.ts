...
import type { GetApiCustomerApiData, GetApiCustomerApiResponse, PostApiFastOrderApiData, GetApiFastOrderApiPaymentTypesData, GetApiFastOrderApiPaymentTypesResponse, GetApiFastOrderApiPaymentTypeByIdData, GetApiFastOrderApiPaymentTypeByIdResponse, GetApiStockDocumentApiData, GetApiStockDocumentApiResponse, GetApiStockDocumentApiByStockDocumentNumberData, GetApiStockDocumentApiByStockDocumentNumberResponse, GetApiStockMovementApiByIdData, GetApiStockMovementApiByIdResponse, PostApiStockMovementApiData, PostApiStockMovementApiResponse, PostApiStockMovementApiMoveData, PostApiStockMovementApiPrintImportLabelData, PostApiStockMovementApiPrintExportLabelData, GetApiStockProductApiData, GetApiStockProductApiResponse, GetApiStockProductApiByIdData, GetApiStockProductApiByIdResponse, PostRegisterData, PostRegisterError, PostLoginData, PostLoginResponse, PostRefreshData, PostRefreshResponse, MapIdentityApiConfirmEmailData, PostResendConfirmationEmailData, PostForgotPasswordData, PostForgotPasswordError, PostResetPasswordData, PostResetPasswordError, PostManage2FaData, PostManage2FaResponse, PostManage2FaError, GetManageInfoData, GetManageInfoResponse, GetManageInfoError, PostManageInfoData, PostManageInfoResponse, PostManageInfoError, GetApiWarehousePlaceApiData, GetApiWarehousePlaceApiResponse } from './types.gen';
...
export const getApiCustomerApi = <ThrowOnError extends boolean = false>(options?: Options<GetApiCustomerApiData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiCustomerApiResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const postApiFastOrderApi = <ThrowOnError extends boolean = false>(options?: Options<PostApiFastOrderApiData, ThrowOnError>) => {
...
export const getApiFastOrderApiPaymentTypes = <ThrowOnError extends boolean = false>(options?: Options<GetApiFastOrderApiPaymentTypesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiFastOrderApiPaymentTypesResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getApiFastOrderApiPaymentTypeById = <ThrowOnError extends boolean = false>(options: Options<GetApiFastOrderApiPaymentTypeByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiFastOrderApiPaymentTypeByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const postApiStockMovementApiMove = <ThrowOnError extends boolean = false>(options?: Options<PostApiStockMovementApiMoveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
...
export const getApiStockProductApi = <ThrowOnError extends boolean = false>(options?: Options<GetApiStockProductApiData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiStockProductApiResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getApiStockProductApiById = <ThrowOnError extends boolean = false>(options: Options<GetApiStockProductApiByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiStockProductApiByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
